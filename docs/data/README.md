...
- Starter and schedule verification must use the selected KBO public pages documented in `docs/dev-plans/kbo-source-contract.md`.
- Do not fill verification data from portal/news mirrors unless the user explicitly approves a new source.
